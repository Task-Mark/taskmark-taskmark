...
- [x] While the summary is generating, the selected contributor shows a presence message card in a generating state; the finished preview and full summary replace that card.
