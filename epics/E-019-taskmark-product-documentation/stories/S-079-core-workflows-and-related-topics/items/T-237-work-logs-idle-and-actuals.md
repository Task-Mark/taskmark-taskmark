...
id: T-237
type: task
title: Work logs, idle caps, and actual minutes
status: done
priority: medium
size: M
...
# T-237: Work logs, idle caps, and actual minutes

## Description

Document session billable rules, idle next-day 12:00 UTC, session_cap_minutes, shared-batch.

## Acceptance criteria

- [x] Never calendar span for Actual is explicit
- [x] Idle and session caps documented
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:40.182Z | Work logs, idle caps, actuals; shared-batch: 26182 of 480000ms by points |
