...
id: T-235
type: task
title: Document README sections and metrics
status: done
priority: medium
size: M
...
actual_ms: 26182
---
# T-235: Document README sections and metrics

## Description

Document each managed README block and what metrics mean.

## Acceptance criteria

- [x] Project status, open work, changelog, contributors described
- [x] Markers/begin-end comments noted
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:40.182Z | README sections and metrics; shared-batch: 26182 of 480000ms by points |
