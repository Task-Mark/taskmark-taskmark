...
id: T-221
type: task
title: Documentation home and overview page
status: done
priority: medium
size: S
...
# T-221: Documentation home and overview page

## Description

Create the documentation landing/overview page summarizing Taskmark and linking into deep topics.

## Acceptance criteria

- [x] Overview page is reachable from site Docs CTA
- [x] Page links to setup and commands at minimum
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:31.454Z | Documentation overview page; shared-batch: 17454 of 480000ms by points |
