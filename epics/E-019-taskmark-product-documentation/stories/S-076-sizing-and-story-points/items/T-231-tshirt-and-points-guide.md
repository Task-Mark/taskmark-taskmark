...
id: T-231
type: task
title: T-shirt sizes and Fibonacci points guide
status: done
priority: medium
size: M
...
# T-231: T-shirt sizes and Fibonacci points guide

## Description

Document XS–XL map, Fibonacci scale, and how suggestions are chosen on create.

## Acceptance criteria

- [x] Size/points table published
- [x] Suggestion from similar done items summarized
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:40.182Z | T-shirt and Fibonacci points guide; shared-batch: 26182 of 480000ms by points |
