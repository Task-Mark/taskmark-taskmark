...
id: T-226
type: task
title: Document /start-work and /complete-work
status: done
priority: medium
size: M
...
Document session open/close, idle caps, shared-batch, and Actual derivation.

## Acceptance criteria

- [x] /start-work and /complete-work pages or sections exist
- [x] Idle cap and no hand-set actual_minutes called out
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:40.182Z | Documented /start-work and /complete-work; shared-batch: 26182 of 480000ms by points |
