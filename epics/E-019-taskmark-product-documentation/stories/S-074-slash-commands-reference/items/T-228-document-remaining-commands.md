...
id: T-228
type: task
title: Document remaining sync and utility commands
status: done
priority: medium
size: M
...
actual_ms: 26182
---
# T-228: Document remaining sync and utility commands

## Description

Document /sync-status, /sync-repos, /sync-plugin-local, /velocity, /board-status.

## Acceptance criteria

- [x] Each remaining command has purpose and when to use it
- [x] Linked from commands index
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:40.182Z | Documented remaining sync/utility commands; shared-batch: 26182 of 480000ms by points |
