...
id: T-222
type: task
title: Install and plugin setup guide
status: done
priority: medium
size: M
...
# T-222: Install and plugin setup guide

## Description

Document Customize → Plugins local install, reload, and local rsync/dev copy path.

## Acceptance criteria

- [x] Install steps match taskmark-cursor README
- [x] Dev copy / sync-plugin-local noted
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T07:43:14.000Z | 2026-07-28T07:43:40.182Z | Install and plugin setup guide; shared-batch: 26182 of 480000ms by points |
