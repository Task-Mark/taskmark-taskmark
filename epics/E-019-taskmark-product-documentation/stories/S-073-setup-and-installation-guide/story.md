...
As a new user, I want setup docs so I can install the plugin and create my first board.
...
- [T-222: Install and plugin setup guide](items/T-222-install-and-plugin-setup-guide.md)
- [T-223: Board init and first-run guide](items/T-223-board-init-and-first-run.md)
