...
id: T-128
type: task
title: Add timeframe controls slot to list filters bar
status: done
priority: high
size: S
...
actual_ms: 21333
---
# T-128: Add timeframe controls slot to list filters bar

## Description

Provide a UI slot/region on the shared filters bar for year/week and date-range controls without breaking existing search/hide-completed layout.

## Acceptance criteria

- [x] Filters bar can host timeframe controls.
