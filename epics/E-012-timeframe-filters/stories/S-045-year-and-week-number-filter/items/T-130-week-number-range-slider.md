...
id: T-130
type: task
title: Build week number range slider UI
status: done
priority: high
size: M
...
# T-130: Build week number range slider UI

## Description

Implement a dual-thumb (or equivalent) week range slider labeled by week numbers for the selected year.

## Acceptance criteria

- [x] User can select a contiguous week range.
- [x] Current range is visible (e.g. W12–W18).
- [x] Slider updates filter state used by lists.
