...
id: T-248
type: task
title: Expand Next metadata for local board UI
status: done
priority: high
size: M
...
actual_ms: 14661
---
# T-248: Expand Next metadata for local board UI

## Description

Improve `taskmark-frontend` root metadata: title, description, applicationName, themeColor; keep local-app tone (not marketing SEO spam).

## Acceptance criteria

- [x] Metadata object documents product purpose clearly.
- [x] themeColor set for browser chrome.
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T14:47:21Z | 2026-07-28T14:47:35.661Z | Expanded frontend SEO metadata; shared-batch: 14661 of 161269ms by points |
