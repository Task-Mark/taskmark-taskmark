...
id: T-254
type: task
title: Wire Open Graph and Twitter on local board UI
status: done
priority: medium
size: M
...
actual_ms: 14660
---
# T-254: Wire Open Graph and Twitter on local board UI

## Description

Add OG/Twitter metadata on the frontend package for completeness when served; note localhost absolute URL limits.

## Acceptance criteria

- [x] Metadata includes og title/description/image when a public base is configured, or sensible relative defaults documented.
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T14:47:21Z | 2026-07-28T14:47:35.660Z | Wired OG/Twitter on frontend; shared-batch: 14660 of 161269ms by points |
