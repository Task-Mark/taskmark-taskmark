...
id: T-253
type: task
title: Wire Open Graph and Twitter on website
status: done
priority: medium
size: M
...
actual_ms: 14661
---
# T-253: Wire Open Graph and Twitter on website

## Description

Add `openGraph` + `twitter` fields in website layout (or shared metadata module) pointing at the OG image with absolute URLs via `metadataBase`.

## Acceptance criteria

- [x] `twitter:card` is `summary_large_image` (or justified alternative).
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T14:47:21Z | 2026-07-28T14:47:35.661Z | Wired OG/Twitter on website; shared-batch: 14661 of 161269ms by points |
