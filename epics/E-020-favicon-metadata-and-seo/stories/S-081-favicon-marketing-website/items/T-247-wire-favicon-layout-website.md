...
id: T-247
type: task
title: Wire favicon and webmanifest in website layout
status: done
priority: high
size: M
...
# T-247: Wire favicon and webmanifest in website layout

## Description

Update `taskmark-website/app/layout.tsx` metadata icons and manifest; align theme/background colors with brand if needed.

## Acceptance criteria

- [x] Primary favicon is no longer only `/tm_light.png`.
- [x] Manifest JSON is linked and valid.
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T14:47:21Z | 2026-07-28T14:47:35.661Z | Wired website icons + layout; shared-batch: 14661 of 161269ms by points |
