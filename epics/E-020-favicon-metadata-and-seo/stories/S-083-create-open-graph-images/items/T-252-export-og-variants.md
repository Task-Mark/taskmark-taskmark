...
id: T-252
type: task
title: Export OG image for apps and optional variant
status: done
priority: high
size: S
...
# T-252: Export OG image for apps and optional variant

## Description

Place the OG asset(s) in both repos as needed; document path(s) for wiring tasks. Optional second crop/variant for docs landing if cheap.

## Acceptance criteria

- [x] Canonical path documented in story notes or README snippet.
- [x] Website has the primary OG file ready to reference.
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-28T14:47:21Z | 2026-07-28T14:47:30.774Z | Exported OG to both public/og paths; shared-batch: 9774 of 161269ms by points |
