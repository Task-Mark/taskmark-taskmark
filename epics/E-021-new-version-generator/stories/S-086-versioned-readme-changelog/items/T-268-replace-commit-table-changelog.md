...
id: T-268
type: task
title: Replace commit-table README changelog with versioned sections
status: shelved
priority: high
size: M
...
actual_ms: 0
---
# T-268: Replace commit-table README changelog with versioned sections

## Description

Redesign the taskmark:changelog markers for ### Development and ### x.y.z sections.

## Acceptance criteria

- [ ] Legacy commit table is no longer the primary changelog format.
- [ ] Markers remain safe for scripted upserts.
