...
Add plugin skill/command that runs discover → suggest/accept → apply as one release step.

## Acceptance criteria

- [ ] Documented skill exists and is invokable from Cursor.
- [ ] Coordinates with changelog stories so release also promotes Development.
