...
Build the epic-specific detail body that presents meta and sections (goal, scope, out of scope, success metrics, stories, commits, work log) in a clear hierarchy inside the shared sheet.
