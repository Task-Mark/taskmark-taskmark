...
- [ ] Overall is the default view and shows the existing nested lists.
- [ ] Drill-down selection behavior is unchanged in Overall.
- [ ] Switching to another view and back to Overall restores the drill-down experience with project context intact.
- [ ] Detail sheet still opens from Overall list rows.
