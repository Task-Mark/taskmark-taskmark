...
id: T-186
type: task
title: Restore velocity skill command and docs
status: done
priority: high
size: M
...
Restore taskmark-velocity skill, /velocity command, conventions, init, overview, and sync-status docs for the new rules.
...
|---------|-------|---------------|-------------|---------|
| 1 | Marco Mendão | 2026-07-27T07:21:27Z | 2026-07-27T07:22:27Z | Restored velocity skill, /velocity, and conventions docs; shared-batch: 1 of 3min by points |
